...
import '../../../../Artist/artifacts/artifactModel.dart';
import '../../../../Artist/artifacts/artifactRepository.dart';
import '../../../Navbar/userNavbar.dart';
import '../../../cart/cartPages/cartPage.dart';
import '../../../dashboard/detailProductPage.dart';

class ArtistsArtifacts extends StatefulWidget{
  final email;


  ArtistsArtifacts(this.email);

  @override
  State<ArtistsArtifacts> createState() => _ArtistsArtifactsState();
}

class _ArtistsArtifactsState extends State<ArtistsArtifacts> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<Artifact_model>>(
          future: getAllData(widget.email),
