...
import 'package:takhleekish/Artist/throughDashboard/Sessions/personalSessions/detailPersonalSessionPage.dart';

import '../../../../User/UserSessionDatabase/sessionModel.dart';
...
class PersonalUserSessions extends StatelessWidget
{
                                              ...
                                              onTap: () {
                                                ...
                                                if (sttimeParts.length ==
                                                  ...
                                                  Navigator.push(context,
                                                    MaterialPageRoute(
                                                        builder: (
                                                            context) =>DetailedPersonalSession(snapshot.data![index].userEmail, snapshot.data![index].Title, startingTime, date)),);
                                                }
